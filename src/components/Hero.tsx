      ...
      <div className="container relative z-10 px-6 py-32">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            Premium web design powered by AI. Mobile-ready, payment-integrated, and SEO-optimized — review at zero cost.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild variant="hero" size="lg" className="text-base px-8 py-6">
              <a href="#contact">View Your Site <ArrowRight className="ml-2 h-5 w-5" /></a>
            </Button>
          </div>
        </motion.div>
      </div>
